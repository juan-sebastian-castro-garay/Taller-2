...
import Taller2_Hamburguesas.Bebida;
...
public class Aplicacion {
	...
	public void mostrarMenu() throws Exception 
	{
		...
		System.out.println("  _      ____                       _                   \r\n"
				...
				+ " | |   | |      / _ \\  | '_ ` _ \\  | '_ \\   / _ \\  / __|\r\n"
				+ " | |   | |___  | (_) | | | | | | | | |_) | | (_) | \\__ \\\r\n"
				+ " |_|    \\____|  \\___/  |_| |_| |_| |_.__/   \\___/  |___/\n");
		System.out.println("  ____      ____                       _                  _                 \r\n"
				+ " |___ \\    |  _ \\   _ __    ___     __| |  _   _    ___  | |_    ___    ___ \r\n"
				+ "   __) |   | |_) | | '__|  / _ \\   / _` | | | | |  / __| | __|  / _ \\  / __|\r\n"
				+ "  / __/    |  __/  | |    | (_) | | (_| | | |_| | | (__  | |_  | (_) | \\__ \\\r\n"
				+ " |_____|   |_|     |_|     \\___/   \\__,_|  \\__,_|  \\___|  \\__|  \\___/  |___/\r\n"
				+ "                                                                            ");
		System.out.println("  _____     ____           _       _       _               \r\n"
				+ " |___ /    | __ )    ___  | |__   (_)   __| |   __ _   ___ \r\n"
				+ "   |_ \\    |  _ \\   / _ \\ | '_ \\  | |  / _` |  / _` | / __|\r\n"
				+ "  ___) |   | |_) | |  __/ | |_) | | | | (_| | | (_| | \\__ \\\r\n"
				+ " |____/    |____/   \\___| |_.__/  |_|  \\__,_|  \\__,_| |___/\r\n"
				+ "                                                           ");
	}
	...
	public void ejecutarOpcionInicio(int pOpcionSeleccionada) throws Exception 
	{
		if(pOpcionSeleccionada== 1)
		{
			...
			System.out.println("3) Agregar bebida a la orden.");
			System.out.println("4) Salir.\n");
			int opccionSeleccionada2 = -1;
			while (opccionSeleccionada2 != 1 &&opccionSeleccionada2 != 2 &&opccionSeleccionada2 != 3&&opccionSeleccionada2 != 4)
			{				
				try {
	...
	/**
	 * Metodo que ejecuta la ocion entrada por parametro. Agregar combo, agregar pedido, agregar bebida o terminar orden.
	 * @param pOpcionSeleccionada int con numero == 1||2||3||4
	 * @throws IOException
	 */
	public void ejecutarOpcionMenu(int pOpcionSeleccionada) throws IOException
	{
		...
		else if(pOpcionSeleccionada== 3)
		{
			...
			while (numeroCorrecto == false)
			{
				try {
					...
					int bebidaAAgregar = (Integer.parseInt(input("Seleccione el combo a agregar.") )-1);
					if ((bebidaAAgregar < restaurante.getBebidas().size()) && (bebidaAAgregar > -1))
					{			
						numeroCorrecto = true;
						restaurante.agregarBebidaAPedido(bebidaAAgregar);
						System.out.println("\nSeleccione una opcion:");
						System.out.println("1) Agregar combo a la orden.");
						System.out.println("2) Agregar producto a la orden.");
						System.out.println("3) Agregar bebida a la orden.");
						...
						{	
							try {
								...
								System.out.println("Seleccione una opcion validacc.");
								opccionSeleccionada2 = 0;
							}
						}
					}
		...
		else if(pOpcionSeleccionada== 4)
		{
			...
			System.out.println("----------------------------------------------\r\n"
					...
					+ "----------------------------------------------");
			if(restaurante.exstePedido() == true)
			{
				System.out.println("Existe un pedio identico.");
			}
	...
	public void imprimirProductos()
	{
		...
		for (ProductoMenu producto : restaurante.getMenuBase()) {
			...
			System.out.println("-----------" + producto.getCalorias()+ " calorias");
			contador = contador +1;
		}
	...
	/**
	 * Imprime en consola las bebidas
	 */
	public void imprimirBebidas()
	{
		...
		for (Bebida bebidas : restaurante.getBebidas()) {
			...
			System.out.println(contador+". "+bebidas.getNombre()+" $" + bebidas.getPrecio()+". ");
			System.out.println("-----------" + bebidas.getCalorias()+ " calorias");
			contador = contador +1;
		}
	...
	public void imprimirAdicionesConPrecio()
	{
		...
		for (Ingrediente ingrediente : restaurante.getIngredientes()) {
			...
			System.out.println("\n" + contador+". "+ingrediente.getNombre()+" $" + ingrediente.getCostoAdicional());
			System.out.println("-----------" + ingrediente.getCalorias()+ " calorias");
			contador = contador +1;
		}
	}
